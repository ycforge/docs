...
This section is for those developing the `@ycforge/ydb-orm` library itself. Sources live in the `../yorm` directory.
...
- `src/cli/` — the `yorm` binary (completion, diff, migrations).
